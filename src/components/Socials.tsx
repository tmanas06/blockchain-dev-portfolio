...
const Socials: React.FC = () => {
  return (
    <div className="absolute top-4 left-4 flex space-x-6">
      <a 
        href="https://github.com/tmanas06" 
        target="_blank" 
        rel="noopener noreferrer" 
        className="text-[#00ff00] hover:text-green-400 transition-colors duration-200"
      >
      ...
      <a 
        href="https://techieresearch.blogspot.com/" 
        target="_blank" 
        rel="noopener noreferrer" 
        className="text-[#00ff00] hover:text-green-400 transition-colors duration-200"
      >
